...
var result = words.filter((element) => { return element.length > 6; });
...
var found = array2.find(item => item > 10);
...
var found2 = array3.findIndex(item => item > 13);
...
var found5 = array6.some(function (element) {
    return element % 2 === 0;
});
...
var found6 = array7.every(element => {
    return element < 40;
});
...
let found7 = array8.reduce(function (previousValue, currentValue) {
